...
"""
Configuration with proper parameter separation and NO preprocessing.
Each model gets only the parameters it actually accepts.
"""
import torch
...
DEFAULT_CONFIG = {
    ...
    # Model parameters - COMPLETELY SEPARATED by model type
    "models": {
        "random_forest": {
            "n_estimators": 200,
            "max_depth": 15,
            ...
            "criterion": "gini",
            "bootstrap": True
            # REMOVED: Any preprocessing parameters
        },
        "svm": {
            # ONLY SVM-specific parameters
            "C": 1.0,
            "kernel": "rbf",
            "gamma": "scale",
            "class_weight": "balanced",
            ...
            "random_state": 42,
            "optimize_hyperparams": False,
            "use_pca": False,  # PCA WITHOUT standardization
            "pca_variance": 0.95
            # REMOVED: n_components parameter that was causing the error
        },
        "mlp": {
            "hidden_layer_sizes": (64, 128, 32),
            "activation": "relu",
            ...
            "batch_size": "auto",
            "learning_rate": "adaptive",
            "learning_rate_init": 0.0001,  # REDUCED for raw signal stability
            ...
            "random_state": 42,
            "optimize_hyperparams": False
            # REMOVED: Any standardization parameters
        },
        "fcnn": {
            "hidden_dims": [256, 128, 64],
            "output_dim": 2,
            ...
            "patience": 15,
            "random_state": 42
            # REMOVED: Any normalization parameters
        },
        "cnn": {
            "n_filters": [32, 64, 128],  # REDUCED for stability
            "kernel_size": 5,
            "output_dim": 2,
            "dropout_rate": 0.2,
            "learning_rate": 0.0005,
    ...
    "visualization": {
        ...
        "format": "png",
        "signal_colors": {
            "calcium_signal": "#356d9e",  # Blue for raw calcium
            "deltaf_signal": "#4c8b64",   # Green for ΔF/F
            "deconv_signal": "#a85858"    # Red for deconvolved
        }
    },
