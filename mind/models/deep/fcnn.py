...
#
# """
# Fully Connected Neural Network WITHOUT standardization.
# This version removes all normalization to test raw signal magnitude effects on deep learning.
# """
# import torch
# import torch.nn as nn
# import torch.nn.functional as F
...
# class FCNNModel(nn.Module):
#     """
#     FCNN model WITHOUT any normalization for raw signal testing.
#
#     This module removes batch normalization and tests how deep learning
#     handles different signal scales naturally through weight adaptation.
#     """
#
#     def __init__(self,
#                  input_dim: int,
...
#                  output_dim: int = 2,
#                  dropout_rate: float = 0.4):
#         """Initialize FCNN WITHOUT normalization."""
#         super(FCNNModel, self).__init__()
#
#         # Store parameters
#         self.input_dim = input_dim
...
#         self.dropout_rate = dropout_rate
#
#         # Create layers list WITHOUT batch normalization
#         layers = []
#
#         # Input layer
#         prev_dim = input_dim
...
#             layers.append(nn.Linear(prev_dim, hidden_dim))
#
#             # REMOVED: Batch normalization - let the network handle scale differences
#             # Add ReLU activation
#             layers.append(nn.ReLU())
#
#             # Add dropout for regularization
...
#         self.output_layer = nn.Linear(hidden_dims[-1], output_dim)
#
#         logger.info(f"Initialized FCNN WITHOUT normalization, hidden dims {hidden_dims}")
#
#     def forward(self, x):
...
#             x = x.view(batch_size, -1)
#
#         # Pass through hidden layers (no normalization)
#         x = self.hidden_layers(x)
#
#         # Pass through output layer
#         x = self.output_layer(x)
...
#     def get_feature_importance(self, window_size: int, n_neurons: int) -> np.ndarray:
#         """
#         Estimate feature importance WITHOUT normalization.
#
#         This is particularly interesting because weights will show
#         how the network naturally adapts to different signal scales.
#         """
#         # Get the weights of the first layer
#         first_layer = None
#         for layer in self.hidden_layers:
...
#         feature_importance = feature_importance.reshape(window_size, n_neurons)
#
#         logger.info(f"FCNN feature importance extracted WITHOUT normalization")
#         logger.info(f"  Weight magnitude range shows network's adaptation to signal scales")
#
#         return feature_importance
#
#
# class FCNNWrapper:
#     """
#     FCNN wrapper WITHOUT normalization for raw signal testing.
#
#     This wrapper removes all data normalization to study how deep learning
#     naturally handles the different scales of calcium imaging signals.
#     """
#
#     def __init__(self,
#                  input_dim: Optional[int] = None,
...
#                  device: str = 'cuda' if torch.cuda.is_available() else 'cpu',
#                  random_state: int = 42):
#         """Initialize FCNN wrapper WITHOUT normalization."""
#
#         # Set random seed for reproducibility
#         torch.manual_seed(random_state)
#         if torch.cuda.is_available():
...
#         self.criterion = None
#
#         logger.info(f"Initialized FCNN wrapper WITHOUT normalization (device={device})")
#
#     def _prepare_data(self, X, y=None):
#         """
#         Prepare data WITHOUT any normalization.
#
#         This method only handles tensor conversion.
#         All signal scales and magnitudes are preserved completely.
#         """
#         # Convert numpy arrays to torch tensors if needed
#         if isinstance(X, np.ndarray):
#             X = torch.FloatTensor(X)
...
#         logger.info(f"FCNN data prepared WITHOUT normalization:")
...
#         logger.info(f"  Deep learning will adapt weights to handle these scales")
#
#         return X, y
#
#     def fit(self, X_train, y_train, X_val=None, y_val=None):
#         """Train FCNN WITHOUT normalization."""
#         logger.info("Training FCNN WITHOUT normalization")
#
#         # Initialize input dimension if not provided
#         if self.input_dim is None:
#             if X_train.ndim == 3:
...
#
#         logger.info("FCNN training complete WITHOUT normalization")
#
#         return self
#
#     def predict(self, X):
